...
const WorkCard = (props) => {
  ...
  return (
    <div className="rounded-br-[50px] rounded-bl-lg text-left rounded-t-lg bg-white p-6 w-96 font-open drop-shadow-md group/graf hover:drop-shadow-2xl relative overflow-hidden">
